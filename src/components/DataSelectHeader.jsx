...
const DataSelectHeader = ({ dropdown, setDropdown }) => {
	const { currentView, setCurrentView, setCurrentUser } = useContext(GlobalContext); 
		...
		<>
		  <div className='flex items-center justify-start h-28 w-[100%]'>
			<h3 className='font-semibold text-xl text-blue-100 p-3 border-b-2 border-blue-200 
						   flex items-center justify-center w-[60%] ml-[20%]'>Select Category</h3>
			{ dropdown === true ?
...
export default DataSelectHeader